...
const Login = () => {
  ...
  const { handleSubmit, register } = useForm<LoginProps>({
    resolver: yupResolver<LoginProps>(schema),
  });
  ...
  return (
    <div className="flex justify-around h-2/4 w-3/4 sm:max-xl:flex-col sm:max-xl:items-center">
      <img
        ...
        alt="hello"
        className="w-1/2 h-2/3 sm:max-md:hidden rounded-md"
      />
      <div className=" w-96 h-svh ">
        ...
        <div className="flex flex-col gap-8">
          <button className="flex items-center justify-center gap-2 w-full h-14 border-2 drop-shadow-lg border-gray-400 rounded-md hover:scale-105">
            <FcGoogle size={30} />
            Sign up with Google
          </button>
          <p>
